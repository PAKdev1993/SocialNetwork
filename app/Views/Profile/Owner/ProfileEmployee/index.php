            ...
            <section class="top" id="myprofile-top">
                ...
                <div class="bd-profile-sections">
                    ...
                    <div class="bt-container" id="bt-gamer-profile">
                        <a role="button" class="bt unactive" href="index.php?p=profile&u=<?=$currentUser->slug ?>"><?= $langFile->profilepart_title_gamer ?></a>
                    </div>
                    <div class="bt-container" id="bt-employee-profile">
                        <a role="button" class="bt" href="index.php?p=profile&u=<?=$currentUser->slug ?>&s=employee"><?= $langFile->profilepart_title_employee ?></a>
                    </div>
                </div>
            </section>
            <section id="myprofile-bottom" class="bottom">
                <aside class="aside aside-left">
                    ...
                    <div class="profile-section-container col-md-12">
                        ...
                        <div class="mobile" id="employee-summary-bloc-mobile" data-elem="employee-summary-bloc">
                            <?= $summary ?>
                        </div>
                ...
                <aside class="aside aside-right">
                    ...
                    <div id="employee-summary-bloc" data-elem="employee-summary-bloc">
                        <?= $summary ?>
                    </div>
