...
namespace app\Controllers\Landing\Parrain;

use app\Controllers\AppController;
use app\App;


class LandingParrainController extends AppController
{
    //ENTER PARAMETERS
    private $admin;
