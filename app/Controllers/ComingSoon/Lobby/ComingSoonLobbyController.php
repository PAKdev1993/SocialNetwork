<?php
namespace app\Controllers\ComingSoon\Lobby;

use app\Controllers\AppController;
use core\Header\Header;
use core\Profile\AppProfile;

class ComingSoonLobbyController extends AppController
{
    //ENTER PARAMETERS
    private $admin;
    ...
    public function showComingSoonLoby()
    {
    ...
    public function index()
    {
        ...
        {
            $contentArray = $this->showComingSoonLoby();
