...
class displayFollowNotifEmail extends AppEmailElems
{
    private $userTo;
    private $userFrom;
    ...
    public function __construct($useridFrom, $useridTo, $notifLink)
    {
        ...
        $followerNotif =    10; //code notif
        $this->traducedMessage = $langModel->getMessageLangNotif($this->userTo->langWebsite, $followerNotif);
        $this->traducedBt = $langModel->getMessageLangBtNotifMail($this->userTo->langWebsite, $followerNotif);
