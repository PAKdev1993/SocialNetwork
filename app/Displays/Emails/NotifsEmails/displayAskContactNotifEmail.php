...
class displayAskContactNotifEmail extends AppEmailElems
{
    private $userTo;
    private $userFrom;
    ...
    public function __construct($useridFrom, $useridTo, $notifLink)
    {
        ...
        $askContactNotif =  12; //code notif
        //#todo optimiser ca c'est debile
        $this->traducedMessage = $langModel->getMessageLangNotif($this->userTo->langWebsite, $askContactNotif);
        $this->traducedBt = $langModel->getMessageLangBtNotifMail($this->userTo->langWebsite, $askContactNotif);
        ...
        return '<body marginwidth="0" marginheight="0">
                    <table border="0" style="width:100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                <td style="border-left: 2px solid rgba(243,177,75,1);font-size:20px;line-height:60px;text-align:right;padding-right:10px;" width="80%" height="10" colspan="2">
                                    <!--[if mso]>
                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="'. $this->baseLink .'index.php?p=profile&u='. $this->userFrom->slug .'" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="25%" strokecolor="#ED7D31" fillcolor="#F9B14C">
                                        <w:anchorlock/>
                                ...
                                <td style="border-right: 2px solid rgba(243,177,75,1);font-size:20px;line-height:60px;text-align:right;padding-right:10px;" width="50%" height="10" colspan="2">
                                    ...
                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="'. $this->baseLink . $this->linkNotif .'" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="25%" strokecolor="#ED7D31" fillcolor="#F9B14C">
                                        <w:anchorlock/>
                                        <center style="color:#ffffff;font-family:sans-serif;font-size:13px;font-weight:bold;">'. $this->traducedBt[0]->bt_accept .'</center>
                                    </v:roundrect>
                                    <![endif]-->
                                    <a href="'. $this->baseLink . $this->linkNotif .'" style="background-color:#F9B14C;border:4px solid #ED7D31;border-radius:15px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:14px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">'. $this->traducedBt[0]->bt_accept .'</a>
                                </td>
                            </tr>                                                     
                            <tr>
