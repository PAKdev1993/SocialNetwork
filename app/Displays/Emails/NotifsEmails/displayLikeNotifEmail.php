...
class displayLikeNotifEmail extends AppEmailElems
{
    private $userTo;
    private $userFrom;
    ...
    public function __construct($useridFrom, $useridTo, $notifLink)
    {
        ...
        $likeNotif = 8; //code notif
        $this->traducedMessage = $langModel->getMessageLangNotif($this->userTo->langWebsite, $likeNotif);
        $this->traducedBt = $langModel->getMessageLangBtNotifMail($this->userTo->langWebsite, $likeNotif);
